...
<figure class="flex flex-col items-center">
	<Image
		src="/static/images/reactor-flow-light.svg"
		srcDark="/static/images/reactor-flow-dark.svg"
		alt="avatar"
		width="600px"
		height="600px"
	/>
...
This being my first write-up was full of ups and downs, distractions, but finally made it. Learnt a lot and I hope this reduces the barrier of writing things down.
